...
def test_run_predictions_job_persists_prediction_feature_snapshots(monkeypatch):
    ...
    assert "feature_context" not in feature_snapshot
    assert "feature_metadata" not in feature_snapshot
    assert "source_metadata" not in feature_snapshot
    assert "feature_context" in prediction["summary_payload"]
    assert "feature_metadata" in prediction["summary_payload"]
