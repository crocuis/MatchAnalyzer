...
drop table if exists public.match_card_projection_cache;

create table public.match_card_projection_cache (
  id text primary key,
...
create index match_card_projection_cache_league_sort_idx
  on public.match_card_projection_cache using btree (league_id, sort_bucket, sort_epoch, id);

create index match_card_projection_cache_sort_idx
